...
def ingreso_busqueda():
    ...
    CONTROLLER.buscar_cliente(cedula)
...
def ingreso_de_datos_factura():
    ...
    CONTROLLER.crear_factura(fecha)
...
def run_fertilizante():
    ...
    if command == 'C':
        CRUD_fertilizante.crear_fertilizante()
    elif command == 'L':
        imprimir_fertilizante(CRUD_fertilizante.registros_fertilizantes)
    elif command == 'E':
        CRUD_fertilizante.eliminar_fertilizante()
    elif command == 'S':
        escoger_opciones()
    else:
        print("comando invalido")
...
def run_plagas():
    ...
    if command == 'C':
        CRUD_control_de_plagas.crear_pesticida()
    elif command == 'L':
        imprimir_plagas(CRUD_control_de_plagas.registros_pesticidas)
    elif command == 'E':
        CRUD_control_de_plagas.eliminar_pesticida()
    elif command == 'S':
        escoger_opciones()
    else:
        print("comando invalido")
